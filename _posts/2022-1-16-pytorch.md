...
title: $PyTorch$ 常用代码段
categories: [PyTorch]
description: PyTorch 常用代码段
keywords: PyTorch
---
[深度学习框架]$PyTorch$常用代码段 原文在[这里](https://zhuanlan.zhihu.com/p/104019160)
...
def convertBNtoSyncBN(module, process_group=None):
    ...
    if isinstance(module, torch.nn.modules.batchnorm._BatchNorm):
        sync_bn = torch.nn.SyncBatchNorm(module.num_features, module.eps, module.momentum, module.affine, module.track_running_stats, process_group)
